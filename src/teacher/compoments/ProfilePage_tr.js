...
const ProfilePage_tr = () => {
  ...
  const handleComplaint = () => {
    ...
    navigation.navigate('Complaint_tr');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.settingItem} onPress={handleMakupClass}>
        <Image
          style={styles.iconStyle}
          source={require('../../Asset/Icon/makup.png')}
        />
        <Text style={styles.settingText}>Makup Classes</Text>
        <Image
          style={[styles.iconStyle, styles.iconStyleAdd]}
          source={require('../../Asset/Icon/greater.png')}
        />
      </TouchableOpacity>
      <TouchableOpacity style={styles.settingItem} onPress={handleComplaint}>
        <Image
          style={styles.iconStyle}
          source={require('../../Asset/Icon/complaint.png')}
        />
        <Text style={styles.settingText}>Complaint</Text>
        <Image
          style={[styles.iconStyle, styles.iconStyleAdd]}
          source={require('../../Asset/Icon/greater.png')}
        />
